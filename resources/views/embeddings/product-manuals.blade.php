...
<main class="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-10 sm:px-6 lg:px-8">
    ...
    <form method="GET" class="grid gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:grid-cols-2 lg:grid-cols-6">
        ...
        <div class="flex gap-2">
            ...
            <button class="rounded-lg bg-emerald-700 px-4 py-2 font-medium text-white">Search</button>
        </div>
    </form>
